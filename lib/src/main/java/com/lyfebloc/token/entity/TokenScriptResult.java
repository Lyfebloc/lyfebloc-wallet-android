...
import static com.lyfebloc.token.tools.TokenDefinition.Syntax.IA5String;
...
/**
 * Created by Lyfebloc on 14/05/2019.
 * Lyfebloc
 */
public class TokenScriptResult
{
    public static final class Attribute {
        ...
        public Attribute(com.lyfebloc.token.entity.Attribute attr, BigInteger value, String text)
        {
            this.id = attr.name;
