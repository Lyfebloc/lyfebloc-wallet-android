...
import com.lyfebloc.token.util.DateTime;
import com.lyfebloc.token.util.DateTimeFactory;
...
/**
 * Created by Lyfebloc on 9/05/2019.
 * Lyfebloc
 */
        ...
        switch (getAs())
        {
            ...
            case Mapping:
                ...
                else
                {
                    ...
                    //refer to 'Lyfebloc meetup indices' where 'Match' mapping is null but for FIFA is not.
