package com.lyfebloc.token.web;

import static com.lyfebloc.token.tools.Convert.getEthString;
import static com.lyfebloc.token.tools.ParseMagicLink.normal;
import static com.lyfebloc.token.web.Ethereum.TokenscriptFunction.ZERO_ADDRESS;
...
import com.lyfebloc.token.entity.MagicLinkInfo;
...
import com.lyfebloc.token.web.Ethereum.TokenscriptFunction;
import com.lyfebloc.token.web.Ethereum.TransactionHandler;
import com.lyfebloc.token.web.Service.CryptoFunctions;
...
public class AppSiteController implements AttributeInterface
{
    ...
    private static final String appleAssociationConfig = "{\n" +
            ...
            "    \"details\": [\n" +
            "      {\n" +
            "        \"appID\": \"LRAW5PL536.com.stormbird.lyfebloc\",\n" +
            "        \"paths\": [ \"*\" ]\n" +
            "      }\n" +
            "    ]\n" +
            "  }\n" +
    ...
    private static final String androidAssociationConfig = "[\n" +
            ...
            "      \"package_name\": \"com.lyfebloc.wallet\",\n" +
    ...
    private static String infuraKey = "92c0d79057dd4703b0ff053198623ca6";
    ...
    public RedirectView home(RedirectAttributes attributes){
        return new RedirectView("http://lyfebloc.com");
    }
            ...
            throws IOException, SAXException, NoHandlerFoundException
    {
        ...
        {
            return "If you are using Lyfebloc with WalletConnect, please launch the Lyfebloc app";
        }
