...
public abstract class C {
    ...
    public static final String ALPHAWALLET_WEB = "https://www.lyfebloc.com";
    ...
    public static final String PRUNE_ACTIVITY =
            "com.lyfebloc.wallet.PRUNE_ACTIVITY";

    public static final String RESET_WALLET =
            "com.lyfebloc.wallet.RESET";
    public static final String ADDED_TOKEN =
            "com.lyfebloc.wallet.ADDED";
    public static final String CHANGED_LOCALE =
            "com.lyfebloc.wallet.CHANGED_LOCALE";
    public static final String PAGE_LOADED =
            "com.lyfebloc.wallet.PAGE_LOADED";
    public static final String RESET_TOOLBAR =
            "com.lyfebloc.wallet.RESET_TOOLBAR";
    public static final String SIGN_DAPP_TRANSACTION =
            "com.lyfebloc.wallet.SIGN_TRANSACTION";
    public static final String REQUEST_NOTIFICATION_ACCESS =
            "com.lyfebloc.wallet.REQUEST_NOTIFICATION";
    public static final String BACKUP_WALLET_SUCCESS =
            "com.lyfebloc.wallet.BACKUP_SUCCESS";
    public static final String CHANGE_CURRENCY =
            "com.lyfebloc.wallet.CHANGE_CURRENCY";
    public static final String RESET_TRANSACTIONS =
            "com.lyfebloc.wallet.RESET_TRANSACTIONS";
    public static final String WALLET_CONNECT_REQUEST =
            "com.lyfebloc.wallet.WALLET_CONNECT";
    public static final String WALLET_CONNECT_NEW_SESSION =
            "com.lyfebloc.wallet.WC_NEW_SESSION";
    public static final String WALLET_CONNECT_FAIL =
            "com.lyfebloc.wallet.WC_FAIL";
    public static final String WALLET_CONNECT_COUNT_CHANGE =
            "com.lyfebloc.wallet.WC_CCHANGE";
    public static final String WALLET_CONNECT_CLIENT_TERMINATE =
            "com.lyfebloc.wallet.WC_CLIENT_TERMINATE";
    public static final String WALLET_CONNECT_SWITCH_CHAIN =
            "com.lyfebloc.wallet.WC_SWITCH_CHAIN";
    public static final String WALLET_CONNECT_ADD_CHAIN =
            "com.lyfebloc.wallet.WC_ADD_CHAIN";
    public static final String SHOW_BACKUP = "com.lyfebloc.wallet.CHECK_BACKUP";
    public static final String HANDLE_BACKUP = "com.lyfebloc.wallet.HANDLE_BACKUP";
    public static final String FROM_HOME_ROUTER = "HomeRouter";
    public static final String TOKEN_CLICK = "com.lyfebloc.wallet.TOKEN_CLICK";
    public static final String SETTINGS_INSTANTIATED = "com.lyfebloc.wallet.SETTINGS_INSTANTIATED";
    public static final String APP_FOREGROUND_STATE = "com.lyfebloc.APP_FOREGROUND_STATE";
    public static final String EXTRA_APP_FOREGROUND = "com.lyfebloc.IS_FOREGORUND";
    public static final String SIGNAL_NFT_SYNC = "com.lyfebloc.SYNC_NFT";
    public static final String SYNC_STATUS = "com.lyfebloc.SYNC_STATUS";
    ...
    public static final String DAPP_PREFIX_ALPHAWALLET = "lyfebloc";
    ...
    public static final String ALPHAWALLET_LOGO_URI = "https://lyfebloc.com/wp-content/themes/lyfebloc/img/logo-horizontal-new.svg";
    public static final String ALPHAWALLET_WEBSITE = "https://lyfebloc.com";
    ...
    public static final String EXTERNAL_APP_DOWNLOAD_LINK = "https://lyfebloc.com/download/Lyfebloc-release-build.apk";
}
