...
import com.lyfebloc.app.entity.EnsNodeNotSyncCallback;
...
/**
 * Created by Lyfebloc on 11/08/2021
 */
@AndroidEntryPoint
public class TransferNFTActivity extends BaseActivity implements TokensAdapterCallback, StandardFunctionInterface, AddressReadyCallback, ActionSheetCallback, EnsNodeNotSyncCallback
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        long chainId = getIntent().getLongExtra(C.EXTRA_CHAIN_ID, com.lyfebloc.ethereum.EthereumNetworkBase.MAINNET_ID);
