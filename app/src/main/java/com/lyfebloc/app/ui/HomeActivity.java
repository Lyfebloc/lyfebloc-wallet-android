...
import static com.lyfebloc.app.C.ADDED_TOKEN;
import static com.lyfebloc.app.C.CHANGED_LOCALE;
import static com.lyfebloc.app.C.CHANGE_CURRENCY;
import static com.lyfebloc.app.C.RESET_TOOLBAR;
import static com.lyfebloc.app.C.RESET_WALLET;
import static com.lyfebloc.app.C.SETTINGS_INSTANTIATED;
import static com.lyfebloc.app.C.SHOW_BACKUP;
import static com.lyfebloc.app.entity.WalletPage.ACTIVITY;
import static com.lyfebloc.app.entity.WalletPage.DAPP_BROWSER;
import static com.lyfebloc.app.entity.WalletPage.SETTINGS;
import static com.lyfebloc.app.entity.WalletPage.WALLET;
...
import com.lyfebloc.app.api.v1.entity.request.ApiV1Request;
...
import com.lyfebloc.app.entity.HomeCommsInterface;
import com.lyfebloc.app.entity.HomeReceiver;
import com.lyfebloc.app.entity.MediaLinks;
import com.lyfebloc.app.entity.SignAuthenticationCallback;
import com.lyfebloc.app.entity.Wallet;
import com.lyfebloc.app.entity.WalletPage;
...
import com.lyfebloc.app.service.PriceAlertsService;
import com.lyfebloc.app.ui.widget.entity.ActionSheetCallback;
import com.lyfebloc.app.ui.widget.entity.PagerCallback;
import com.lyfebloc.app.util.LocaleUtils;
import com.lyfebloc.app.util.UpdateUtils;
import com.lyfebloc.app.util.Utils;
import com.lyfebloc.app.viewmodel.BaseNavigationActivity;
import com.lyfebloc.app.viewmodel.HomeViewModel;
import com.lyfebloc.app.viewmodel.WalletConnectViewModel;
import com.lyfebloc.app.walletconnect.AWWalletConnectClient;
...
import com.lyfebloc.app.widget.AWalletConfirmationDialog;
        ...
        FragmentMessenger, Runnable, ActionSheetCallback, LifecycleObserver, PagerCallback
{
    ...
    {
        Timber.tag("LIFE").d("Lyfebloc into foreground");
        if (viewModel != null)
        {
    ...
    {
        Timber.tag("LIFE").d("Lyfebloc into background");
    ...
    private void checkWarnings()
    {
        if (updatePrompt)
        {
            ...
            if (warns < 3)
            {
                ...
                cDialog.setTitle(R.string.lyfebloc_update);
                cDialog.setCancelable(true);
                cDialog.setSmallText("Using an old version of Lyfebloc. Please update from the Play Store or Lyfebloc website.");
