...
import com.lyfebloc.app.entity.analytics.TokenSwapEvent;
import com.lyfebloc.app.entity.lifi.Chain;
import com.lyfebloc.app.entity.lifi.Connection;
import com.lyfebloc.app.entity.lifi.Quote;
import com.lyfebloc.app.entity.lifi.Token;
import com.lyfebloc.app.ui.widget.entity.ActionSheetCallback;
import com.lyfebloc.app.ui.widget.entity.ProgressInfo;
import com.lyfebloc.app.util.BalanceUtils;
import com.lyfebloc.app.util.SwapUtils;
import com.lyfebloc.app.viewmodel.SwapViewModel;
import com.lyfebloc.app.viewmodel.Tokens;
...
import com.lyfebloc.app.widget.SelectTokenDialog;
import com.lyfebloc.app.widget.StandardHeader;
import com.lyfebloc.app.widget.SwapSettingsDialog;
import com.lyfebloc.app.widget.TokenInfoView;
import com.lyfebloc.app.widget.TokenSelector;
...
public class SwapActivity extends BaseActivity implements StandardFunctionInterface, ActionSheetCallback
{
    ...
    private com.lyfebloc.app.entity.tokens.Token token;
    ...
    private ActionSheetDialog createConfirmationAction(Quote quote)
    {
        ...
        try
        {
            com.lyfebloc.app.entity.tokens.Token activeToken = viewModel.getTokensService().getTokenOrBase(sourceToken.chainId, sourceToken.address);
