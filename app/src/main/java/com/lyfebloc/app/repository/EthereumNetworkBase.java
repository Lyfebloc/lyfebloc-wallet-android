...
import static com.lyfebloc.app.entity.EventSync.BLOCK_SEARCH_INTERVAL;
import static com.lyfebloc.app.entity.EventSync.OKX_BLOCK_SEARCH_INTERVAL;
import static com.lyfebloc.app.entity.EventSync.POLYGON_BLOCK_SEARCH_INTERVAL;
import static com.lyfebloc.app.util.Utils.isValidUrl;
import static com.lyfebloc.ethereum.EthereumNetworkBase.ARBITRUM_GOERLI_TESTNET_FALLBACK_RPC_URL;
import static com.lyfebloc.ethereum.EthereumNetworkBase.ARBITRUM_GOERLI_TEST_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.ARBITRUM_MAIN_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.ARTIS_SIGMA1_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.ARTIS_TAU1_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.AURORA_MAINNET_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.AURORA_MAINNET_RPC_URL;
import static com.lyfebloc.ethereum.EthereumNetworkBase.AURORA_TESTNET_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.AURORA_TESTNET_RPC_URL;
import static com.lyfebloc.ethereum.EthereumNetworkBase.AVALANCHE_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.AVALANCHE_RPC_URL;
import static com.lyfebloc.ethereum.EthereumNetworkBase.BINANCE_MAIN_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.BINANCE_TEST_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.CLASSIC_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.CRONOS_MAIN_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.CRONOS_TEST_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.FANTOM_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.FANTOM_RPC_URL;
import static com.lyfebloc.ethereum.EthereumNetworkBase.FANTOM_TEST_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.FANTOM_TEST_RPC_URL;
import static com.lyfebloc.ethereum.EthereumNetworkBase.FUJI_TEST_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.FUJI_TEST_RPC_URL;
import static com.lyfebloc.ethereum.EthereumNetworkBase.GNOSIS_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.GOERLI_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.HECO_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.HECO_RPC_URL;
import static com.lyfebloc.ethereum.EthereumNetworkBase.HECO_TEST_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.HECO_TEST_RPC_URL;
import static com.lyfebloc.ethereum.EthereumNetworkBase.IOTEX_MAINNET_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.IOTEX_MAINNET_RPC_URL;
import static com.lyfebloc.ethereum.EthereumNetworkBase.IOTEX_TESTNET_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.IOTEX_TESTNET_RPC_URL;
import static com.lyfebloc.ethereum.EthereumNetworkBase.KLAYTN_BAOBAB_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.KLAYTN_BAOBAB_RPC;
import static com.lyfebloc.ethereum.EthereumNetworkBase.KLAYTN_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.KLAYTN_RPC;
import static com.lyfebloc.ethereum.EthereumNetworkBase.MAINNET_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.MILKOMEDA_C1_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.MILKOMEDA_C1_RPC;
import static com.lyfebloc.ethereum.EthereumNetworkBase.MILKOMEDA_C1_TEST_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.MILKOMEDA_C1_TEST_RPC;
import static com.lyfebloc.ethereum.EthereumNetworkBase.OKX_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.OKX_RPC_URL;
import static com.lyfebloc.ethereum.EthereumNetworkBase.OPTIMISM_GOERLI_TESTNET_FALLBACK_RPC_URL;
import static com.lyfebloc.ethereum.EthereumNetworkBase.OPTIMISM_GOERLI_TEST_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.OPTIMISTIC_MAIN_FALLBACK_URL;
import static com.lyfebloc.ethereum.EthereumNetworkBase.OPTIMISTIC_MAIN_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.PALM_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.PALM_TEST_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.POA_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.POLYGON_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.POLYGON_TEST_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.SEPOLIA_TESTNET_ID;
import static com.lyfebloc.ethereum.EthereumNetworkBase.SEPOLIA_TESTNET_RPC_URL;
import static com.lyfebloc.ethereum.EthereumNetworkBase.XDAI_RPC_URL;
...
import com.lyfebloc.app.entity.ContractLocator;
import com.lyfebloc.app.entity.ContractType;
...
import com.lyfebloc.app.entity.tokens.TokenInfo;
import com.lyfebloc.app.util.Utils;
import com.lyfebloc.token.entity.ChainSpec;
...
public abstract class EthereumNetworkBase implements EthereumNetworkRepositoryType
{
    ...
    public static final String DEFAULT_INFURA_KEY = "92c0d79057dd4703b0ff053198623ca6";
    /* constructing URLs from BuildConfig. In the below area you will see hardcoded key like da3717...
       These hardcoded keys are fallbacks used by Lyfebloc forks.
    ...
    //Note that Lyfebloc now uses a double node configuration. See class AWHttpService comment 'try primary node'.
