...
public class MediaLinks
{
    ...
    public static final String MEDIA_TARGET_APPLICATION = "com.lyfebloc.wallet";
    public static final String AWALLET_TELEGRAM_URL = "https://t.me/LyfeblocSupport";
    ...
    public static final String AWALLET_TWITTER_URL = "https://twitter.com/Lyfebloc";
    public static final String AWALLET_FACEBOOK_URL = "https://www.facebook.com/Lyfebloc/";
    public static final String AWALLET_LINKEDIN_URL = null;
    public static final String AWALLET_REDDIT_URL = "https://www.reddit.com/r/Lyfebloc/";
    public static final String AWALLET_INSTAGRAM_URL = null;
    public static final String AWALLET_BLOG_URL = null;
    public static final String AWALLET_FAQ_URL = "https://lyfebloc.com/faq/";
    public static final String AWALLET_GITHUB = "https://github.com/Lyfebloc/lyfebloc-wallet-android/issues";
    public static final String AWALLET_EMAIL1 = "feedback+android";
    public static final String AWALLET_EMAIL2 = "lyfebloc.com";
    public static final String AWALLET_SUBJECT = "Lyfebloc Android Help";
