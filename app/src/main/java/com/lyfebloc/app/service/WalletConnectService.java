...
import static com.lyfebloc.app.C.WALLET_CONNECT_ADD_CHAIN;
import static com.lyfebloc.app.C.WALLET_CONNECT_CLIENT_TERMINATE;
import static com.lyfebloc.app.C.WALLET_CONNECT_COUNT_CHANGE;
import static com.lyfebloc.app.C.WALLET_CONNECT_FAIL;
import static com.lyfebloc.app.C.WALLET_CONNECT_NEW_SESSION;
import static com.lyfebloc.app.C.WALLET_CONNECT_REQUEST;
import static com.lyfebloc.app.C.WALLET_CONNECT_SWITCH_CHAIN;
...
public class WalletConnectService extends Service
{
    ...
    //TODO: Can we determine if Lyfebloc is running? If it is, no need to add this to the queue,
