...
import com.lyfebloc.app.entity.lifi.SwapProvider;
...
import com.lyfebloc.app.ui.SelectRouteActivity;
import com.lyfebloc.app.ui.SelectSwapProvidersActivity;
import com.lyfebloc.app.ui.widget.entity.ProgressInfo;
import com.lyfebloc.app.util.BalanceUtils;
import com.lyfebloc.app.util.Hex;
...
public class SwapViewModel extends BaseViewModel implements TransactionSendHandlerInterface
{
    ...
    {
        com.lyfebloc.app.entity.tokens.Token t;
