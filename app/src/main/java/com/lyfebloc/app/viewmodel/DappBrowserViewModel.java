...
import com.lyfebloc.app.ui.AddEditDappActivity;
...
public class DappBrowserViewModel extends BaseViewModel implements TransactionSendHandlerInterface
{
    ...
    {
        transactionSigned.postValue(new TransactionReturn(com.lyfebloc.token.tools.Numeric.toHexString(sigData.signature), w3Tx));
    }
