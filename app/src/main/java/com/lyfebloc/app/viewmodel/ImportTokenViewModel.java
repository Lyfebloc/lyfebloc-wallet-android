...
import static com.lyfebloc.app.entity.MagicLinkParcel.generateReverseTradeData;
import static com.lyfebloc.token.tools.ParseMagicLink.currencyLink;
import static com.lyfebloc.token.tools.ParseMagicLink.customizable;
import static com.lyfebloc.token.tools.ParseMagicLink.normal;
import static com.lyfebloc.token.tools.ParseMagicLink.spawnable;
import static com.lyfebloc.token.tools.ParseMagicLink.unassigned;
...
import com.lyfebloc.app.entity.tokens.TokenFactory;
...
public class ImportTokenViewModel extends BaseViewModel implements TransactionSendHandlerInterface
{
    ...
    ImportTokenViewModel(GenericWalletInteract genericWalletInteract,
                         ...
                         LyfeblocService alphaWalletService,
