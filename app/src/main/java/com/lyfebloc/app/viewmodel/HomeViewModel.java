...
import static com.lyfebloc.app.viewmodel.WalletConnectViewModel.WC_SESSION_DB;
...
import com.lyfebloc.app.entity.GitHubRelease;
...
import com.lyfebloc.app.entity.Version;
...
import com.lyfebloc.app.ui.AddTokenActivity;
import com.lyfebloc.app.ui.HomeActivity;
import com.lyfebloc.app.ui.ImportWalletActivity;
...
import com.lyfebloc.app.walletconnect.entity.WCUtils;
import com.lyfebloc.app.widget.EmailPromptView;
import com.lyfebloc.app.widget.QRCodeActionsView;
import com.lyfebloc.app.widget.WhatsNewView;
...
{
    public static final String ALPHAWALLET_DIR = "Lyfebloc";
    ...
    private Request getRequest()
    {
        return new Request.Builder()
            ...
            .url("https://api.github.com/repos/lyfebloc/lyfebloc-wallet-android/releases")
            .get()
            .build();
    }
