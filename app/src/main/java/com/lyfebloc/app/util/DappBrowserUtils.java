...
public class DappBrowserUtils {
    ...
    private static final String DEFAULT_HOMEPAGE = "https://lyfebloc.com/browser/";
    private static final String POLYGON_HOMEPAGE = "https://lyfebloc.com/browser-item-category/polygon/";
