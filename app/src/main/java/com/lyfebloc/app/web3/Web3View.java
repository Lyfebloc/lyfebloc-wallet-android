...
public class Web3View extends WebView {
    ...
    private static final String JS_PROTOCOL_ON_SUCCESSFUL = "Lyfebloc.executeCallback(%1$s, null, \"%2$s\")";
    private static final String JS_PROTOCOL_EXPR_ON_SUCCESSFUL = "Lyfebloc.executeCallback(%1$s, null, %2$s)";
    private static final String JS_PROTOCOL_ON_FAILURE = "Lyfebloc.executeCallback(%1$s, \"%2$s\", null)";
