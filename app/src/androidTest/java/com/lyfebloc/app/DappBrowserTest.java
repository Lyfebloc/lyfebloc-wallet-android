...
import static com.lyfebloc.app.steps.Steps.navigateToBrowser;
import static com.lyfebloc.app.steps.Steps.openOptionsMenu;
import static com.lyfebloc.app.steps.Steps.selectTestNet;
import static com.lyfebloc.app.util.Helper.click;
import static com.lyfebloc.app.util.Helper.waitUntilLoaded;
...
public class DappBrowserTest extends BaseE2ETest
{
    ...
    public void should_suggest_websites()
    {
        ...
        assertUrlContains("lyfebloc.app.entity.DApp@");
    }
