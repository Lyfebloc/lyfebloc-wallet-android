...
/**
 * Created by Lyfebloc on 9/02/2019.
 * Lyfebloc
 */
public class UniversalLinkTypeTest
{
    ...
    {
        //generate link
        BigInteger szaboAmount = com.lyfebloc.token.tools.Convert.fromWei(DROP_VALUE, com.lyfebloc.token.tools.Convert.Unit.SZABO).abs().toBigInteger();
