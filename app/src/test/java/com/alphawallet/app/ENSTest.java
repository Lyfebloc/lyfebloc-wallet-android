...
import static com.lyfebloc.app.web3j.ens.NameHash.nameHash;
...
//            ensResolver.resolve("vladylav.wallet"), ("0xac1de5bbdc2c8d0b3e4324c87599dc66d3221c13").toLowerCase());
    ...
    {
        assertEquals(
            ensResolver.resolveAvatar("alphaid.eth"), ("https://drive.google.com/a/lyfebloc.com/file/d/129glXWa1Y2nOZQNwvx8sA5fR1KuGAW4m/view?usp=drivesdk"));
    }
